 ...
 * link:https://content.enablement.pivotal.io/spring-boot-primer/spring-data-rest/index.html[_Polyglot Persistence with Spring Data REST_]
 * Lab 2: https://content.enablement.pivotal.io/spring-boot-primer/spring-data-rest/index.html[Build a Hypermedia-Driven RESTful Web Service with Spring Data REST]
